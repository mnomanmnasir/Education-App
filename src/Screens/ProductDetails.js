...
const ProductDetails = () => {
  ...
  const [selectedProduct, setSelectedProduct] = useState(SuggestedProducts[0]); // Initially select the first product
    ...
    <View style={styles.container}>
      ...
      <View style={styles.bodyContainer}>
        ...
        <ScrollView
          ...
          horizontal={true}
          contentContainerStyle={styles.suggestedProductContent} // Add this line
        >
          {SuggestedProducts.map((product, index) => (
            ...
            >
              ...
              >
                <Image source={product.thumbnail} style={styles.suggestedImg} />
                <Text style={styles.suggestedProductTitle}>
                  {product.title}
                </Text>
              </Animated.View>
            </TouchableOpacity>
